...
<section class="flex flex-col justify-between items-start">
    <article>
        <h3 class="text-5xl font-semibold">Challengers (2024)</h3>
        <h4 class="text-slate-700 text-2xl font-bold">The future of humanity is in her hands.</h4>
    </article>
    <div class="w-full relative flex gap-[5px] flex-wrap">
    ...
    <div class="relative bg-white text-slate-900 rounded-full border-2">
    ...
    <article>
        <h5 class="text-3xl font-bold">Sinopsis</h5>
        <p class="mb-5 text-lg font-normal leading-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam beatae quisquam delectus placeat distinctio error, inventore ducimus rem laudantium, accusantium ipsa dignissimos eos eaque cumque laboriosam recusandae explicabo earum qui.</p>
        <div class="py-2 flex gap-4 border border-transparent border-b-slate-800">
            ...
            <div>
                ...
                <span class="text-gray-400 text-lg font-bold">Apr 18, 2024</span>
            </div>
            <div>
