    ...
    <article class="w-full h-[450px] md:h-[700px] flex items-center relative">
        ...
        <x-web-container>
            <section class="max-w-[800px] mx-auto flex flex-col items-center text-center relative">
                ...
                <span class="font-medium text-[18px] md:text-[24px] mb-[40px]">{{ __('messages.millons of movies and series, explore now.') }}</span>
                <form class="w-full flex items-center" action="{{ route('search') }}" method="GET">
                    ...
                    <button type="submit" class="w-[100px] md:w-[150px] h-[50px] md:h-[60px]
